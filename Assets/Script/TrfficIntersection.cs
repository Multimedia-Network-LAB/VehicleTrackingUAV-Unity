...
public class TrfficIntersection : MonoBehaviour
{
    [Range(0f, 2f)]
    [SerializeField]private float waypointSize = 1f;
    public List<TrfficIntersection> connectedIntersections; // 인접 교차로 리스트
    ...
    private void OnDrawGizmos()
    {
        ...
        {
            foreach (TrfficIntersection neighbor in connectedIntersections)
            {
                if (neighbor != null)
                {
